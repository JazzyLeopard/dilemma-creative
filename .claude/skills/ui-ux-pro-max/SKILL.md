...
- Product type: SaaS
- Style keywords: modern, professional
- Industry: Technology
...
```bash
python3 .claude/skills/ui-ux-pro-max/scripts/search.py "SaaS technology modern professional" --design-system -p "MyApp"
```
...
python3 .claude/skills/ui-ux-pro-max/scripts/search.py "modern professional clean" --domain typography
```
